...
//  -------------
//      cpp
pub(crate) fn generate(_ast: &crate::parser::Ast, orig_path: &PathBuf) -> Result<(), String> {
    let (dir, stem_name) = get_dir_stem_name(&orig_path)?;
    {
        ...
        if !exists_file(&full_file_name) {
            let content = "templates::h_gen_file::t()";
...
// fn exists_file(full_file_name: &str) -> bool {
//     std::path::Path::new(&full_file_name).exists()
// }

// fn write_file(full_file_name: &str, content: &str) -> Result<(), String> {
